...
public interface UserSessionRI extends Remote {
        ...
        public TaskSubjectRI createTask(String name, String hashType, ArrayList<String> hashPass, Integer delta
                , String uname, int strategy, HashMap<String, String> dataStrategy, Integer taskCredits, Client client, String url) throws RemoteException;

...
public class UserSessionImpl extends UnicastRemoteObject implements UserSessionRI{
    ...
    public TaskSubjectRI createTask(String name, String hashType, ArrayList<String> hashPass, Integer creditsProc, Integer creditsFound, Integer delta, String uname, int strategy, HashMap<String, String> dataStrategy, Integer taskCredits, Client client) throws RemoteException {
        ...
        switch (strategy){
            case 1:
                taskSubjectRI = new TaskSubjectImplS1(name, hashType, hashPass, creditsProc, creditsFound, delta,taskCredits,client);
                break;
            case 2:
                ...
                taskSubjectRI = new TaskSubjectImplS2(name, hashType, hashPass, creditsProc, creditsFound, delta, len2,taskCredits,client);
                break;
            case 3:

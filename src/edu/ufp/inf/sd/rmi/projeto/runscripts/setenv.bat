...
@REM JDK="C:\Program Files\JetBrains\IntelliJ IDEA 2019.3.3\jbr"
...
@REM JAVAPROJ=%WORKDRIVE%:\\Users\\%USERNAME%\\Documents\\GitHub\\%JAVAPROJ_NAME%
...
@set CLASSPATH=.;%JAVAPROJ_DIST_FOLDER%/%JAVAPROJ_JAR_FILE%.jar
